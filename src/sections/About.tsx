        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <motion.p
            ...
            dangerouslySetInnerHTML={{
              __html: interpolate(t.about.description, {
                name: `<span class="text-[#3d9df3] font-semibold">${t.about.name}</span>`,
                stack: `<span class="text-[#3d9df3] font-medium">${t.about.stack}</span>`,
              }),
            }}
          />
